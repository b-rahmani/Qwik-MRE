        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mt-5 md:mt-10">
            {
                items?.map((item, index) => <>
                    ...
                    >
                        ...
                        />
                        <div class="w-full h-full absolute z-10 bg-slate-950/50 bottom-0 md:-bottom-full group-hover:bottom-0 transition-all duration-300 cursor-pointer">
                            <Magnifying class="absolute w-12 aspect-square start-0 end-0 mx-auto -translate-y-1/2 inset-y-1/2 text-gray-100" />
                        </div>
                    </div>
                </>)
            }
