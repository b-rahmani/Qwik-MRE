...
const ResearchOfficeInfo = component$(({
    address,
    addressIcon,
    addressTitle,
    firstPhone,
    ...
    postalCodeIcon,
    postalCodeTitle,
    researchOfficeMapLatitude,
    researchOfficeMapLongitude,
    secondPhone,
    secondPhoneTitle,
    thirdPhone,
    thirdPhoneTitle,
        ...
        <ul class='grid grid-cols-1 grid-rows-9'>
            ...
            <li class="row-span-4">
                <Map
                    ...
                    zoom={15}
                    coordinates={[researchOfficeMapLatitude, researchOfficeMapLongitude]}
                    marker={{
                        coordinates: [researchOfficeMapLatitude, researchOfficeMapLongitude]
                    }}
                    id='ResearchInfo'
...
export default ResearchOfficeInfo
